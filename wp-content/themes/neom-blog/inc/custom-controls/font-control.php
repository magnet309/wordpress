 ...
 *
 * @package     neom
 * @copyright   Copyright (c) 2022, neom
 * @since       1.0
 */
...
class neom_Icon_Picker_Control extends WP_Customize_Control {


	private $icons = false;

	public function __construct( $manager, $id, $args = array(), $options = array() ) {
		$this->icons = $this->neom_get_icons();
	...
	public function enqueue() {
		...
		wp_enqueue_style( 'fonticonpicker-css', NEOM_PARENT_URI . '/assets/fonticonpicker/jquery.fonticonpicker.min.css', false );

		wp_enqueue_script( 'fonticonpicker-js', NEOM_PARENT_URI . '/assets/fonticonpicker/jquery.fonticonpicker.min.js', array( 'jquery', 'jquery-ui-sortable' ) );
	}

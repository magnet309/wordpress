(function ($) {
    ...
    wp.neomcustomizerRepeater = {
        ...
        init: function () {
            $('.iconpicker-items>i').on('click', function () {
                ...
                neom_customizer_repeater_refresh_social_icons(th);
                return false;
            });
        },
    ...
    $(document).ready(function () {
        wp.neomcustomizerRepeater.init();

        $('.iconpicker-search').on('keyup', function () {
            wp.neomcustomizerRepeater.search($(this));
        });

        $('.icp-auto').on('click', function () {
            wp.neomcustomizerRepeater.iconPickerToggle($(this));
        });

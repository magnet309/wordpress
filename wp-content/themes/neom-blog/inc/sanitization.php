 ...
 */
function neom_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function neom_sanitize_number_absint( $number, $setting ) {
 ...
 */
function neom_sanitize_html( $html ) {
 ...
 *                    the setting default.
 */
function neom_sanitize_range_value( $number, $setting ) {
 ...
 */
function neom_sanitize_select( $input, $setting ) {
 ...
 */
function neom_sanitize_url( $url ) {
	return esc_url_raw( $url );
}

/* Sanitization Text*/
function neom_sanitize_text( $text ) {
	return wp_filter_post_kses( $text );
}

/* Sanitization Integer*/
function neom_sanitize_integer( $input ) {
	if ( is_numeric( $input ) ) {
		return intval( $input );
	}
}
